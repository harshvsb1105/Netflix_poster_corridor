...
final List<Content> previews = const [
  Content(
    ...
    titleImageUrl: Assets.atlaTitle,
      description: 'This is Netflix original Poster with high quality and depth colors'
...
final List<Content> myList = const [
  Content(name: 'Violet Evergarden', imageUrl: Assets.violetEvergarden ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.htsdof ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Kakegurui', imageUrl: Assets.kakegurui ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesday ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Black Mirror', imageUrl: Assets.blackMirror ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Violet Evergarden', imageUrl: Assets.violetEvergarden ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.htsdof ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Kakegurui', imageUrl: Assets.kakegurui ,description: 'This is Netflix original Poster with high quality and depth colors'),
  Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesday ,description: 'This is Netflix original Poster with high quality and depth colors'),
